...
const (
	...
	// V2 Rollout flag messages (Phase 7)

	// MessageTypeServerFlags sends current V2 rollout flag state to clients.
	// This is sent on connect and whenever flags change.
	// Payload: ServerFlagsPayload
	MessageTypeServerFlags MessageType = "server.flags"

	// MessageTypeServerFlagsChanged notifies clients of a flag state change.
	// Payload: ServerFlagsPayload
	MessageTypeServerFlagsChanged MessageType = "server.flags_changed"
)
...
// V2 Rollout Flag types and constructors (Phase 7)

// ServerFlagsPayload carries the current V2 rollout flag state.
type ServerFlagsPayload struct {
...
// NewServerFlagsMessage creates a message with current flag state.
func NewServerFlagsMessage(payload ServerFlagsPayload) Message {
	return Message{Type: MessageTypeServerFlags, Payload: payload}
}

// NewServerFlagsChangedMessage creates a flag change notification message.
func NewServerFlagsChangedMessage(payload ServerFlagsPayload) Message {
	return Message{Type: MessageTypeServerFlagsChanged, Payload: payload}
}
