...
Commands:
  ...
  flags list                 Show V2 rollout flags and metrics
  flags enable <phase>       Enable a V2 phase flag
  flags disable <phase>      Disable a V2 phase flag
  flags promote <phase>      Enable with gate verification
  flags rollout-stage <stage>  Set rollout stage
  flags kill-switch <on|off>   Toggle V2 kill switch
